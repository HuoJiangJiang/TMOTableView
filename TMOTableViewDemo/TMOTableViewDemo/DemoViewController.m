...
//You will discover, UITableViewController & UIViewController + TMOTableView is the same code to implement.
...
- (void)setupFirstLoad {
    ...
    [self.tableView firstLoadWithBlock:^(TMOTableView *tableView, DemoViewController *viewController) {
...
- (void)setupRefreshControl {
    [self.tableView refreshWithCallback:^(TMOTableView *tableView, DemoViewController *viewController) {
...
- (void)setupLoadMore {
    [self.tableView loadMoreWithCallback:^(TMOTableView *tableView, DemoViewController *viewController) {
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(10.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        [self.tableView.myLoadMoreControl setLoadMoreCallback:^(TMOTableView *tableView, DemoViewController *viewController) {
            dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(1.0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
